...
public class StockDAOImpl {
    public static boolean saveStock(StockDto stock) throws SQLException, ClassNotFoundException {
    ...
    public static boolean updateStock(StockDto stock) throws SQLException, ClassNotFoundException {
    ...
    public static boolean deleteStock(StockDto productId) throws SQLException, ClassNotFoundException {
