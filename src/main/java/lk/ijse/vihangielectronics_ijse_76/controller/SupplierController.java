...
import lk.ijse.vihangielectronics_ijse_76.dao.SupplierDAO;
import lk.ijse.vihangielectronics_ijse_76.dao.SupplierDAOImpl;
...
public class SupplierController implements Initializable {
    ...
    private void handleSupplierSave() {
        try {
            ...
            if (supplierDAO.saveSupplier(dto)) {
    ...
    private void handleUpdateSupplier() {
        try {
            ...
            if (supplierDAO.updateSupplier(dto)) {
    ...
    private void loadSupplierTable() {
        try {
            List<SupplierDto> list = supplierDAO.getAllSuppliers();
