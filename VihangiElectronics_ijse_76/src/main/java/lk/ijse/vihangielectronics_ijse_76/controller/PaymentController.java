...
import lk.ijse.vihangielectronics_ijse_76.bo.custom.impl.PaymentBOImpl;
...
//    private final PaymentDAO paymentDAO = new PaymentDAOImpl();
    ...
    private void handleSavePayment() {
        ...
        try {
            ...
            if (paymentBO.isPaymentExists(dto.getPaymentId())) {
    ...
    private void handleSearchPayment() {
        ...
        try {
            PaymentDto dto = paymentBO.searchPayment(txtSearchPayment.getText());
