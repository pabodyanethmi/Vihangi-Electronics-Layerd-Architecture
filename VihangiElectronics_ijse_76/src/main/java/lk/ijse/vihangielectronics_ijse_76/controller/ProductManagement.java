...
import lk.ijse.vihangielectronics_ijse_76.bo.custom.impl.ProductBOImpl;
...
//    private final String PRODUCT_NAME_REGEX = "^[A-Za-z]{3,}$";
    ...
    void handleDeleteProduct() {
        ...
        if (!productId.matches(PRODUCT_ID_REGEX)) {
            ...
            try {
                boolean result = productBO.deleteProduct(productId);
    ...
    public void loadProductTable() {
        try {
            List<ProductDto> productDtoList = productBO.getAllProducts();
    ...
    private void generateProductId() {
        try {
            String nextId = productBO.nextProductId();
